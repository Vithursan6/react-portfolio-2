    ...
    <div className='skills'>
                <h2 className='skills-h'>I have experience with these technologies:</h2>
                    <div className="skillsGrid">
                        ...
                        <Skill source="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/mongodb/mongodb-original-wordmark.svg" alt="The logo icon for Mongodb" title="mongo-i"/>
                        <Skill source="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/mysql/mysql-original-wordmark.svg" alt="The logo icon for MySQL" title="mysql-i"/>
                        ...
                        <Skill source="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/bootstrap/bootstrap-original-wordmark.svg" alt="The logo icon for bootstrap" title="bootstrap-icon"/>
                        <Skill source="https://cdn.jsdelivr.net/gh/devicons/devicon/icons//firebase/firebase-plain-wordmark.svg" alt="The logo icon for Firebase" title="firebase-i"/>
                        <Skill source="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/git/git-original-wordmark.svg" alt="The logo icon for Git" title="git-i"/>
                        <Skill source="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/graphql/graphql-plain-wordmark.svg" alt="The logo icon for graphql" title="graphql-i"/>
                        <Skill source="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/jquery/jquery-plain-wordmark.svg" alt="The logo icon for Jquery" title="jquery-i"/>
                        <Skill source="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/sequelize/sequelize-original-wordmark.svg" alt="The logo icon for Sequelize" title="sequelize-i"/>
                        <Skill source="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/webpack/webpack-original-wordmark.svg" alt="The logo icon for Webpack" title="webpack-i"/>
                        <Skill source="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/nextjs/nextjs-original-wordmark.svg" alt="The logo icon for Next-JS" title="nextjs-i"/>
                        <Skill source="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/heroku/heroku-original-wordmark.svg" alt="The logo icon for Heroku" title="heroku-i"/>
